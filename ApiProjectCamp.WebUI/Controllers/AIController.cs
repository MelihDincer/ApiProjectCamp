        ...
        public async Task<IActionResult> CreateRecipeWithOpenAI(string prompt)
        {
            ...
            var requestData = new
            {
                ...
                messages = new[]
                {
                    new
                    {
                        role="system", content="Sen bir restoran için yemek önerilerini yapan bir yapay zeka aracısın. Amacımız kullanıcı tarafından girilen malzemelere göre yemek tarifi önerisinde bulunmak."
                    },
                    new
                    {
            ...
            {
                ViewBag.recipe = "Bir hata oluştu. Hata mesajı: " + response.StatusCode;
            }
            return View();
        }
